...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by John Doe.create': {
    roles: ['business-owner', 'operations-manager', 'customer-service-representative', 'operations-staff'],
    key: 'order_create',
    tenantPath: [],
    userPath: [],
  },
  'Inventory for product XYZ is below the threshold.update': {
    roles: ['business-owner', 'operations-manager'],
    key: 'inventory_low',
    tenantPath: [],
    userPath: [],
  },
  'Feedback received from customer Jane Doe.create': {
